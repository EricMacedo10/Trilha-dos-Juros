...
async function initEditorialStatus() {
    ...
    try {
        // We try to fetch the actual file from the production structure
        // Since we are in 5_Central_Comando_Senior, we go up and then into 3_Front_End
        const response = await fetch('../3_Front_End/editorial_feed.json');
